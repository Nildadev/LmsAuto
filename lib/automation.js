...
async function solveLMS(username, password, onConfirm, logger = console.log, autoConfirm = false, debugMode = false) {
    ...
    try {
        ...
        const blacklist = / võ nhạc|thể dục|xuất phát|nhịp điệu|âm nhạc|bốn mùa hòa ca|đá cầu|quan họ|giai điệu/i;
